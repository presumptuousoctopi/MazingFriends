...
/***/ 292:
/*!**********************************************!*\
  !*** ./src/components/Home/FriendSearch.jsx ***!
  \**********************************************/
	...
	var FriendSearch = function (_React$Component) {
	    ...
	    _createClass(FriendSearch, [{
	        ...
	        value: function addFriend() {
	            ...
	            socket.emit("addFriend", { user: localStorage.getItem('user'), friend: this.state.friend });
	        }
	    }, {
	        key: "render",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FriendView = function (_React$Component) {
	    ...
	    _createClass(FriendView, [{
	        ...
	        value: function componentDidMount() {
	            var context = this;
	            socket.emit("getFriends", localStorage.getItem('user'));
...
//# sourceMappingURL=0.3f38bc631e72d276a9a9.hot-update.js.map