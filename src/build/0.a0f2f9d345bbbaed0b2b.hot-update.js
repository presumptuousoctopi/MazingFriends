...
/***/ function(module, exports, __webpack_require__) {
	...
	var FriendView = function (_React$Component) {
	    ...
	    function FriendView() {
	        ...
	        _this.getFriend = _this.getFriend.bind(_this);
	        return _this;
	    }
	    ...
	    _createClass(FriendView, [{
	        ...
	        key: 'getFriend',
	        value: function getFriend(e, index) {
	            var context = this;
	            e.preventDefault();
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    this.state.friends.map(function (data, index) {
	                        return _react2.default.createElement(
	                            'a',
	                            { href: '', onClick: _this2.getFriend(e, index), className: 'friend' },
	                            data.friend
	                        );
	                    })
	                )
...
//# sourceMappingURL=0.a0f2f9d345bbbaed0b2b.hot-update.js.map