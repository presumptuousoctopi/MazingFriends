	        ...
	        value: function componentDidMount() {
	            ...
	            socket.on("friendData", function (data) {
	                ...
	                context.setState({
	                    ...
	                    console.log(context.state.image);
	                });
	            });
	        }
	    }, {
	                ...
	                _react2.default.createElement(
	                    ...
	                    this.state.friends.map(function (data, index) {
	                        return _react2.default.createElement(
	                            ...
	                            _react2.default.createElement('img', { className: 'preview', src: _this2.state.image })
	                        );
	                    })
	                )
	            );
...
//# sourceMappingURL=0.745a1c7475801f4d1bd4.hot-update.js.map