	...
	var FriendView = function (_React$Component) {
	    ...
	    _createClass(FriendView, [{
	        ...
	        value: function getImage(i, e) {
	            e.preventDefault();
	            console.log(this.state.friends[i].image);
	                ...
	                _react2.default.createElement(
	                    ...
	                    this.state.friends.map(function (data, index) {
	                        ...
	                        return _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(_Modal2.default, { show: _this2.state.modalShow, onHide: _this2.modalClose.bind(_this2), content: data.user, title: _this2.state.friends[index].image })
	                        );
	                    })
	                )
	            );
...
//# sourceMappingURL=0.4162e851eb0fe5e07a87.hot-update.js.map